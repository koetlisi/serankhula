...
import {Education, Experience, ResumeInfo, Skill} from "@/app/lib/types/templateTwoInterface";
import {TemplateTwoInterfaceInitialState} from "@/app/lib/appRedux/slice/states/templateTwoInterfaceState";

const resumeSlice = createSlice({
    name: 'resumeTemplateTow',
    initialState:TemplateTwoInterfaceInitialState,
    reducers: {
        ...
        resetResumeInfo(state) {
            state.resumeInfo = TemplateTwoInterfaceInitialState.resumeInfo;
        }
    }
});
