...
export const TemplateTwo = (userData:LoginUserType, resumeInfo:ResumeState) =>{
    return {
        ...
        education: resumeInfo.resumeInfo.education.length > 0
            ? resumeInfo.resumeInfo.education.map((education, index) => ({
                id: index + 1,
        ...
        skills: resumeInfo.resumeInfo.skills.length > 0
            ? resumeInfo.resumeInfo.skills.map((skill, index) => ({
                id: index + 1,
